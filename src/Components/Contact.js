...
const Contact =()=>{
    return(
        <div className="flex flex-col justify-center align-center sm:flex-row sm:justify-between w-[100%] bg-[#FFF9E5] sm:p-20">
          ...
          <div className="sm:w-[50%] w-[100%] ml-2 flex flex-col gap-3"> 
             <div className="text-[#313531] font-Helvetica text-sm font-bold leading-5 mt-2">
              <p>Company Name</p>
              <input className="w-[90%] h-[60px] rounded-lg bg-[#D6D3CA]"></input>
            </div>
            <div className="text-[#313531] font-Helvetica text-sm font-bold leading-5 mt-2">
              <p>Full Name</p>
              <input className="w-[90%] h-[60px] rounded-lg bg-[#D6D3CA]"></input>
            ...
            <div className="text-[#313531] font-Helvetica text-sm font-bold leading-5 mt-2">
              ...
              <input className="w-[90%] h-[240px] rounded-lg bg-[#D6D3CA]"></input>
            </div>
            <div>
             <Button className="w-[90%] p-0 rounded-lg my-2 bg-[#D8A600] text-[#FFFFFF]">Send</Button>
            </div> 
           </div>
         </div>
